...
# Connect to the persistent ChromaDB database used by the application.

client = chromadb.PersistentClient(path="./chroma_db")

collection = client.get_or_create_collection("chromadb_collection")

# Sample documents used to test insertion into the collection.
...
# Store the documents with matching IDs.
collection.add(
    documents=documents,
